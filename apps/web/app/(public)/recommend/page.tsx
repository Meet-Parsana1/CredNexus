...
function RecommendWizard() {
      ...
      const paramPurpose = (searchParams?.get('purpose') as SchemeCategory | 'any') || 'business';
      const paramAmount = Number(searchParams?.get('amount')) || 120000;

      const [step, setStep] = useState<number>(1);
      const totalSteps = 4;

      // Form State initialized with query params from hero if available
                  ...
                  <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="text-center space-y-2 mb-8">
                              ...
                              <p className="text-xs sm:text-sm text-slate-600 max-w-lg mx-auto">
                                    Answer a few transparent questions about your financing requirement. Our
                                    deterministic rules engine matches you to eligible apex schemes.
                              </p>
                        </div>
                                          ...
                                          <div className="space-y-5 animate-in fade-in-50">
                                                <div>
                                                      ...
                                                      <p className="text-xs text-slate-500 mt-0.5">
                                                            Select your primary requirement so we can match targeted
                                                            sectoral schemes.
                                                      </p>
                                                </div>
                                                            ...
                                                            return (
                                                                  ...
                                                                  >
                                                                        <div className="flex items-start gap-3">
                                                                              <div
                                                                                    className={`p-2 rounded-lg ${isSelected ? 'bg-royal-600 text-white' : 'bg-slate-100 text-slate-700'}`}
                                                                              >
                                                                                    <Icon className="w-5 h-5" />
                                                                              </div>
                                                                              <div>
                                                                                    <h4 className="font-bold text-xs text-navy-800">
                                                                                          {item.title}
                                                                                    </h4>
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                      {[50000, 120000, 300000, 500000, 1500000].map((amt) => (
                                                            <button
                                                                  ...
                                                                  type="button"
                                                                  onClick={() =>
                                                                        setFormData({ ...formData, projectCost: amt })
                                                                  }
                                    ...
                                    {step === 3 && (
                                          <div className="space-y-5 animate-in fade-in-50">
                                                <div>
                                                      ...
                                                      <p className="text-xs text-slate-500 mt-0.5">
                                                            Government concessional schemes have statutory income
                                                            criteria (e.g. ₹3L or ₹5L).
                                                      </p>
                                                </div>
                                                ...
                                                <div className="pt-2">
                                                      <label className="flex items-center gap-2.5 p-3 rounded-xl border border-slate-200 hover:bg-slate-50 cursor-pointer">
                                                            ...
                                                            <span className="text-xs font-semibold text-navy-800">
                                                                  Applicant is a Woman Entrepreneur / Student (unlocks
                                                                  0.5% interest concession)
                                                            </span>
                                                      </label>
                                                </div>
                                          </div>
                                          ...
                                          <div className="bg-white rounded-2xl border-2 border-royal-500 p-6 sm:p-8 shadow-elevated space-y-6">
                                                <div className="flex flex-wrap items-center justify-between gap-3 pb-4 border-b border-slate-100">
                                                      <div className="flex items-center gap-2">
                                                            ...
                                                            <Badge
                                                                  variant={results[0].isEligible ? 'emerald' : 'red'}
                                                                  size="md"
                                                            >
                                                                  {results[0].isEligible
                                                                        ? 'Eligible'
                                                                        : 'Conditions Unmet'}
                                                            </Badge>
                                                      </div>
                                                ...
                                                <div className="space-y-3">
                                                      ...
                                                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 py-4 text-xs">
                                                            <div className="bg-slate-50 p-3 rounded-xl">
                                                                  ...
                                                                  <span className="font-extrabold text-navy-800 text-sm font-tabular">
                                                                        {formatINR(results[0].scheme.maxLoanAmount)}
                                                                  </span>
                                                            </div>
                                                            <div className="bg-slate-50 p-3 rounded-xl">
                                                                  <span className="text-[10px] text-slate-400 font-bold uppercase block">
                                                                  ...
                                                                  <span className="font-extrabold text-royal-600 text-sm font-tabular">
                                                                        {results[0].scheme.interestRateMin}% -{' '}
                                                                        {results[0].scheme.interestRateMax}%
                                                                  </span>
                                                            </div>
                                                            <div className="bg-slate-50 p-3 rounded-xl">
                                                                  <span className="text-[10px] text-slate-400 font-bold uppercase block">
                                                                  ...
                                                                  <span className="font-extrabold text-navy-800 text-sm font-tabular">
                                                                        {results[0].scheme.moratoriumMaxMonths} Months
                                                                  </span>
                                                            </div>
                                                            <div className="bg-emerald-50 p-3 rounded-xl border border-emerald-200">
                                                                  ...
                                                                  <span className="font-extrabold text-emerald-700 text-sm font-tabular">
                                                                        {formatINR(
                                                                              results[0].calculatedIndicativeEMI || 0,
                                                                        )}{' '}
                                                                        / mo
                                                                  </span>
                                                            </div>
                                                            ...
                                                            {results[0].unmetCriteria.length > 0 && (
                                                                  <div className="pt-2 border-t border-slate-200">
                                                                        <span className="font-bold text-red-600 flex items-center gap-1">
                                                                              <XCircle className="w-3.5 h-3.5" /> Unmet
                                                                              Criteria:
                                                                        </span>
                                                                        <ul className="space-y-1 text-red-700 pl-5 list-disc mt-1">
                                                                              {results[0].unmetCriteria.map(
                                                                                    (c, idx) => (
                                                                                          <li key={idx}>{c}</li>
                                                                                    ),
                                                                              )}
                                                ...
                                                <div className="pt-4 border-t border-slate-100 flex flex-wrap items-center gap-3">
                                                      ...
                                                      <Link
                                                            href={`/calculator?amount=${formData.projectCost}&rate=${results[0].scheme.interestRateMin}&tenure=${results[0].scheme.tenureMaxMonths}&moratorium=${results[0].scheme.moratoriumMaxMonths}`}
                                                      >
                                                            <Button
                                                                  variant="outline"
                                                                  size="md"
                                                      ...
                                                      <Link
                                                            href={`/partners?scheme=${results[0].scheme.code}&state=${formData.state}`}
                                                      >
                                                            <Button
                                                                  variant="emerald"
                                                                  size="md"
                                                      ...
                                                      >
                                                            <div className="space-y-2">
                                                                  ...
                                                                  <div className="text-xs text-slate-600 pt-2 border-t border-slate-100 flex justify-between font-tabular">
                                                                        <span>
                                                                              Max:{' '}
                                                                              {formatINR(item.scheme.maxLoanAmount)}
                                                                        </span>
                                                                        <span>
                                                                              Rate: {item.scheme.interestRateMin}%
                                                                        </span>
                                                                  </div>
                                                            </div>
                  ...
                  fallback={
                        <div className="min-h-screen bg-slate-50 flex items-center justify-center py-20">
                              <div className="text-sm font-semibold text-slate-500">
                                    Loading Scheme Matching Wizard...
                              </div>
                        </div>
                  }
            >
